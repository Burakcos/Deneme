<%@ WebHandler Language="C#" Class="AssetManagment.Handlers.Export" %>
...
{
	public class Export : GenericHandlerBase, IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
