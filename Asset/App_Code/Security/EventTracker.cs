...
namespace AssetManagment.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("ModifiedBy|updated_by", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedByUserIdRegex = new Regex("ModifiedByUserId", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedOnRegex = new Regex("ModifiedOn|updated|update_date", RegexOptions.IgnoreCase);
        
        private static Regex _createdByUserNameRegex = new Regex("CreatedBy", RegexOptions.IgnoreCase);
        
        private static Regex _createdByUserIdRegex = new Regex("CreatedById|created_user_id", RegexOptions.IgnoreCase);
        
        private static Regex _createdOnRegex = new Regex("CreatedOn|create_date", RegexOptions.IgnoreCase);
