...
namespace AssetManagment.Services
{
    ...
    public class RepresentationalStateTransferBase : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public static Regex ScriptResourceRegex = new Regex("^(?\'ScriptName\'[\\w\\-]+?)(\\-(?\'Version\'[\\.\\d]+))?(\\.(?\'Culture\'[\\w\\-]+?))?\\.js", RegexOptions.IgnoreCase);
        ...
        protected virtual void CombineScripts(HttpContext context, bool isSaaS, string scriptName, string culture, string version)
        {
            ...
            if (isSaaS)
            {
                if (ApplicationServices.IsMobileClient)
                	sb.AppendFormat(String.Format("$(\'<link></link>\').appendTo($(\'head\')).attr({{ href: \'{0}/mobile//jquery.mobile-{" +
                                "1}.min.css\', type: \'text/css\', rel: \'stylesheet\' }});", ApplicationServices.JqmVersion), baseUrl, ApplicationServices.JqmVersion);
                else
                	sb.AppendFormat(String.Format("$(\'<link></link>\').appendTo($(\'head\')).attr({{ href: \'{0}/App_Themes/AssetManagme" +
                                "nt/_Theme_Yoshi.css?{0}\', type: \'text/css\', rel: \'stylesheet\' }});", ApplicationServices.Version), baseUrl);
                try
                {
                ...
                sb.AppendFormat("var __targetFramework=\'4.5\';__timeZoneUtcOffset={0};__tf=4.0;__cothost=\'appfactor" +
...
#pragma warning restore 0618
        ...
        protected virtual void CompressOutput(HttpContext context, string data)
        {
            HttpRequest request = context.Request;
            HttpResponse response = context.Response;
        ...
        protected virtual void BeginResponsePadding(HttpRequest request, StreamWriter sw)
        {
            ...
            if (!(String.IsNullOrEmpty(callback)))
            	...
            	if ((request.HttpMethod == "GET") && UriRestConfig.IsJSONPRequest(request))
                {
                    ...
                    sw.Write("AssetManagment=typeof AssetManagment==\'undefined\'?{{}}:AssetManagment;AssetManagm" +
                            "ent.{0}=", instance);
                }
        }
