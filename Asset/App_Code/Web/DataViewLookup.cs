...
namespace AssetManagment.Web
{
    ...
    public class DataViewLookup : System.Web.UI.Control, INamingContainer
    {
        ...
        public string SelectedValue
        {
            get
            {
                string v = ((string)(ViewState["SelectedValue"]));
                if (v == null)
                	v = String.Empty;
                return v;
            }
        ...
        protected string LookupText
        {
            get
            {
                string text = ((string)(ViewState["LookupText"]));
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (Page.IsPostBack)
            {
                string valueKey = (_extender.ClientID + "_Item0");
