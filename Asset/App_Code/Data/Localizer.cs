    ...
    public class Localizer
    {
        ...
        public virtual string Replace()
        {
            ...
            if (_baseName == "Pages.")
            {
                ...
                if (((System.Web.UI.Page)(HttpContext.Current.Handler)).Request.Browser.Browser == "IE")
        ...
        public static Stream CreateDictionaryStream(string culture, string baseName, string objectName, out string[] files)
        {
            ...
            Stream result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("AssetManagment.{0}{1}", baseName, fileName), culture));
            if (result == null)
            	result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("AssetManagment.{0}", fileName), culture));
            if (result == null)
            {
        ...
        public static LocalizationDictionary CreateDictionary(string baseName, string objectName)
        {
            ...
            string fileName = String.Format("AssetManagment.{0}.{1}.txt", objectName, culture);
